  ...
  <div>
    ...
    <div class="bs-example">
      ...
      <div class="form-inline clearfix">
        ...
        <div class="form-group col-sm-11 imb">
          <button v-show="isShowSubmit" type="button" class="btn btn-success" @click="submit">确认</button>
          <button v-show="!isShowSubmit" type="button" class="btn btn-success" disabled>确认</button>
          <br/>
          <br/>
