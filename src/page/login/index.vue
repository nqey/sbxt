        ...
        <div  class="loginContent pull-right">
          <div class="login">
            ...
            <ul>
              ...
              <li>
                <input class="input valid" name="password" @keypress="loginBefor($event)" type="password" placeholder="请输入密码" title="密码" v-model="password">
              </li>
              <li>
                <ul class="logo_yzm">
                  <li>
                    <input class="input" type="text" @keypress="loginBefor($event)" name="checknumber" placeholder="请输入验证码"  v-model="checknumber">
                  </li>
...
.ckxq:hover{background:rgb(1, 200, 83); color: #fff;}
</style>