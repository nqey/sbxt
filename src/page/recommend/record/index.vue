...
<script>
  ...
  import { ORGANIZ_SUBSIDY_RECOMMEND_RECORD_QUERY, ORGANIZ_SUBSIDY_RECOMMEND_RECORD_COUNT } from '@/config/env';
  ...
  export default {
    ...
    data() {
      return {
        dataUrl: ORGANIZ_SUBSIDY_RECOMMEND_RECORD_QUERY,
        countUrl: ORGANIZ_SUBSIDY_RECOMMEND_RECORD_COUNT,
        status: {
          pending: '待审核',
          passed: '通过',
          rejected: '未通过',
