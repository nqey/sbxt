...
<script>
  import { ORGANIZ_SUBSIDY_WITHDRAW, ORGANIZ_SUBSIDY_AMOUNT, DECLARE_GET_VALIDATECODE, ORGANIZ_SUBSIDY_WITHDRAW_RUKU, PUBLICS_BANK_LIST } from '@/config/env';
  ...
  export default {
    ...
    methods: {
      ...
      async commit() {
        const res = await this.$http.post(ORGANIZ_SUBSIDY_WITHDRAW_RUKU, this.form);
        if (res.success) {
